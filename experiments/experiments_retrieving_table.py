...
df, latex = scrape_all_logs(metric_names=['user_community_bias', 'ndcg'], log_directory="logs/full_experiments_best_biases/", output_file='logs/full_experiments_best_biases/full_experiments_best_biases.tex', k_values=[10])
print("\nDataFrame:")
print(df)
print("\nLaTeX Table:")
print(latex)
